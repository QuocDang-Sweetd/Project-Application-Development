...
- Quá trình thực hiện :
  - Cấp 0: Làm quen FastAPI (Hello To-Do)
     * Ở cấp này mục tiêu chỉ cần tạo được APT có thể chạy được và thực hiện được một số tác vụ đơn giản quá trình này không quá tốn kém thời gian
     * Đây là một số kết quả đạt được ở cấp 0 của project.
